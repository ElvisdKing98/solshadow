...
export default function Home() {
  ...
  const viewWalletProfile = async (whale: any) => {
    ...
    try {
      const res = await axios.get(
        `${BACKEND}/api/whales/profile?wallet=${whale.walletAddress}&chain=ETH_MAINNET&network=${currentNetwork}`
      );
      ...
      >
        ...
        >
          ...
          >
            <div>
              ...
              >
                Shadow the smartest wallets on Solana & EVM
              </p>
            </div>
        ...
        <section style={{ marginBottom: "32px" }}>
            ...
            {QUICK_TOKENS.map((t) => (
              <button
                ...
                onClick={() => {
                  ...
                  discoverWhales(t.address, t.chain, t.network);
                }}
                style={{
                  background:
          ...
          <div style={{ display: "flex", gap: "8px" }}>
            <input
              type="text"
              placeholder="Or paste any token address (EVM or Solana)..."
              value={customToken}
              ...
              onKeyDown={(e) =>
                e.key === "Enter" && discoverWhales(customToken)
              }
            />
            <button
              ...
              style={{
                ...
                cursor: "pointer",
                fontFamily: "Syne, sans-serif",
                opacity: !customToken || loading ? 0.5 : 1,
          ...
          {(["discover", "signals"] as const).map((tab) => (
            <button
              ...
              style={{
                ...
                color:
                  activeTab === tab ? "var(--bg)" : "var(--text-secondary)",
                border: "none",
                padding: "8px 20px",
                borderRadius: "7px",
                fontWeight: 700,
          ...
          <section>
            ...
            {!loading && whales.length > 0 && (
              <>
                ...
                >
                  FOUND {whales.length} WHALE TRADERS — CLICK A CARD TO VIEW
                  PROFILE
                </p>
                <div
                  style={{
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <div
                  style={{
                    height: "100%",
                    width: `${selectedWallet.score}%`,
                    background:
                      "linear-gradient(90deg, var(--accent), #0066ff)",
                    borderRadius: "3px",
            ...
            >
              <button
                onClick={() => {
                  shadowWallet(selectedWallet.walletAddress);
              ...
              <a
                href={`https://etherscan.io/address/${selectedWallet.walletAddress}`}
                target="_blank"
                rel="noreferrer"
                style={{
                  background: "var(--bg)",
